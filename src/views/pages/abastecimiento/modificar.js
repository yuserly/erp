...
export default {
    ...
    methods: {
        ...
        {
            this.axios
                .get(`${this.urlbackend}/compraemitirdocumento/getDocumentoModificar/`+this.infoEmpresa.id_empresa)
                .then((res) => {
                    console.log(res);
        ...
        {   
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    this.axios
                    .get(`${this.urlbackend}/compraemitirdocumento/emitirDocumento/`+documento)
                    .then((res) => {
                        Swal.fire({
                            icon: 'success',
